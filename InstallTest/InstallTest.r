...
buildings <- st_read(here("InstallTest/data/Campus_Buildings.shp"))
signs <- st_read(here("InstallTest/data/Inventory.shp"))

campus_DEM <- raster(here("InstallTest/data/WestCampusDEM.tif"))
